...
function Chatbot({
    ...
    const send = useCallback(
        ...
        [input, loading, onGenerateAdvice, language, culture, t]
    );
    ...
    useEffect(() => {
        ...
        const trimmed = queuedPrompt.trim();
        if (!trimmed) {
            onPromptConsumed?.();
            return;
        }
    ...
    return (
        <div
            className={`flex h-full flex-col rounded-xl border border-gray-200 bg-white shadow-lg ${className}`}
        >
